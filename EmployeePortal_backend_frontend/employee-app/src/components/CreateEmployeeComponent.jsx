...
class CreateEmployeeComponent extends Component {
    ...
    saveEmployee = (e) => {
        e.preventDefault();
        let employee = {
            name: this.state.name, emailid: this.state.emailid,
            designation: this.state.designation, salary: this.state.salary,
            address1: this.state.address1, address2: this.state.address2, street: this.state.street,
            city: this.state.city, country: this.state.country, postcode: this.state.postcode
        };
        ...
        }else if(!this.state.designation && ! this.state.salary){
            window.alert("please fill the form");
        }else if(!this.state.address1 && ! this.state.city){
            window.alert("please fill the form");

        }else if(!this.state.country && ! this.state.postcode){
            window.alert("please fill the form");
        }
        else{
                                ...
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        {/* <input placeholder="Designation" name="designation" className="form-control" 
                                            ...
                                            /> */}
                                        <select placeholder="Designation" name="designation" className="form-control"
                                            value={this.state.designation}
